function dataplot1 = importfile0(filename, startRow, endRow)
%IMPORTFILE3 Import numeric data from a text file as a matrix.
%   DATAPLOT1 = IMPORTFILE3(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   DATAPLOT1 = IMPORTFILE3(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   dataplot1 = importfile3('data_plot.txt', 1, 60);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/02/25 08:05:33
...
dataplot1 = table;
dataplot1.VarName1 = cell2mat(raw(:, 1));
dataplot1.VarName2 = cell2mat(raw(:, 2));
dataplot1.VarName3 = cell2mat(raw(:, 3));
