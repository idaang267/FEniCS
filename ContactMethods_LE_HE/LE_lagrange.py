...
class topTest(SubDomain):
    def inside(self, x, on_boundary):
        return near(x[1], 1.0) and between(x[0], (0.25, 0.75)) and between(x[2], (0.25, 0.75)) and on_boundary
...
#boundary_restriction = MeshRestriction(mesh, topTest)
