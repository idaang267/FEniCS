...
h1 = plot(y1_d,y2_d,'Color','r', 'LineWidth', 3);
h2 = plot(y1_p_1,y2_p_1, 'Color', 'k', 'LineWidth', 3);
leg = legend([a, h1, h2],["Asymptotic Solution", "Discrete", "Diffused"], 'Location', 'Best');
