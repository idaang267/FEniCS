...
y1_p_1 = PhaseFieldS1.y1;
y2_p_1 = PhaseFieldS1.y2;
y1_p_2 = PhaseFieldS1.y3;
y2_p_2 = PhaseFieldS1.y4;
y1_p_3 = PhaseFieldS1.y5;
y2_p_3 = PhaseFieldS1.y6;
...
ax.FontSize = 15; 
leg = legend([h1, h2, h3],["Analytical", "Discrete: Uniform", "Phase Field: X=10, Y=2"], 'Location', 'Best');
...
%%
saveas(gcf, "Com_0-04_k_10E4_LargeStrain.fig")
