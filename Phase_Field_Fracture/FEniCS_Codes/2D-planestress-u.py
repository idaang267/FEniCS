...
(u, F33) = split(w_p)     # Displacement, pressure, (u, p, F_{33})
(v, v_F33) = split(v_q)   # Test functions for u, p and F33
...
F_u = derivative(elastic_potential, w_p, v_q) \
      + (a(alpha)*mu*(F33-inv(F33)))*v_F33*dx
