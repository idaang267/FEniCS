...
\begin{align*}
\pdv{\mathcal{E}_{\ell}}{\boldsymbol{u}} &= \int_{\Omega} a (\alpha) \pdv{\mathcal{W} (\mathbf{F})}{\mathbf{u}} d \Omega 
\end{align*}
\begin{align*}
\pdv{\mathcal{E}_{\ell}}{p} &= - \int_{\Omega} \frac{p}{\kappa} d \Omega - \int_{\Omega} \sqrt{a^3(\alpha)} (J-1) d \Omega
\end{align*}
\begin{align*}
\pdv{\mathcal{E}_{\ell}}{\alpha} &= - \int_{\Omega} 2 (1 - \alpha) \, \mathcal{W} (\mathbf{F}) \, d \Omega + \int_{\Omega} 3 p (1- \alpha)^2 (J-1) d \Omega + \frac{G_{c}}{c_{w}} \int_{\Omega} \bigg[ \frac{1}{\ell} + 2 \ell \nabla^2 \alpha \bigg] d \Omega 
\end{align*}
